...
public class EditarAluno extends JFrame {
	...
	private JFormattedTextField data_matricula;
	 ...
	 */
	public static void main(String[] args, br.unipe.cc.mlpIII.academico.model.Aluno aluno) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					EditarAluno frame = new EditarAluno(aluno);
	...
	public EditarAluno(Aluno aluno) {
		setTitle("Sistema Acadêmico Source - Editar Aluno");
		...
		mntmNewMenuItem_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				dispose();
				String[] args = null;
				br.unipe.cc.mlplII.academico.ui.Aluno.main(args);
			}
		});
		...
		JMenuItem mntmCadastra = new JMenuItem("Cadastra");
		...
		JLabel lblCadastrarAluno = new JLabel("Editar Aluno");
		...
		sexo.setSelectedItem(aluno.getSexo());
		...
		estado_civil.setSelectedItem(aluno.getEstado_civil());
		...
		profissao.setText(aluno.getProfissao());
		...
		situacao.setModel(new DefaultComboBoxModel(new String[] {"Matriculado", "N\u00E3o Matriculado"}));
		situacao.setSelectedItem(aluno.getSituacao());
		...
		JLabel label_16 = new JLabel("Data da Matricula");
		label_16.setFont(new Font("Tahoma", Font.BOLD, 12));
		label_16.setBounds(96, 382, 133, 15);
		panel.add(label_16);
		
		disciplina = new JComboBox();
		disciplina.setBounds(268, 395, 267, 20);
		...
		JLabel label_18 = new JLabel("Disciplina");
		label_18.setFont(new Font("Tahoma", Font.BOLD, 12));
		label_18.setBounds(268, 382, 133, 15);
		panel.add(label_18);
		
		data_nascimento = new JFormattedTextField();
		data_nascimento.setText(aluno.getData_nascimento());
		data_nascimento.setBounds(242, 217, 159, 20);
		panel.add(data_nascimento);
		
		data_matricula = new JFormattedTextField();
		data_matricula.setText(aluno.getData_matricula());
		data_matricula.setBounds(96, 395, 153, 20);
		panel.add(data_matricula);
	...
	protected void BtnCadastarActionPerformed(ActionEvent e) {
		...
		aluno.setData_matricula(data_matricula.getText());
		aluno.setData_nascimento(data_nascimento.getText());
		aluno.setEmail(email.getText());
		aluno.setEndereco(endereco.getText());
		aluno.setEstado(estado.getText());
		aluno.setEstado_civil((estado_civil.getSelectedItem()).toString());
		aluno.setIdentidade(identidade.getText());
		aluno.setMatricula(matricula.getText());
		aluno.setNome(nome.getText());
		aluno.setProfissao(profissao.getText());
		aluno.setSexo((sexo.getSelectedItem()).toString());
		aluno.setSituacao((situacao.getSelectedItem()).toString());
		aluno.setTelefone(telefone.getText());
		
		Academico academico = new Academico();
		academico.atualizarAluno(aluno);
		academico.cursa(aluno, (disciplina.getSelectedItem()).toString());
