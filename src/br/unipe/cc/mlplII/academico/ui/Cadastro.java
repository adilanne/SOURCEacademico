...
public class Cadastro extends JFrame {
	...
	public Cadastro() {
		...
		disciplina.setBounds(255, 395, 267, 20);
		...
		lblDisciplina.setBounds(255, 382, 133, 15);
		...
		JLabel lblDataDaMatricula = new JLabel("Data da Matricula");
		lblDataDaMatricula.setFont(new Font("Tahoma", Font.BOLD, 12));
		lblDataDaMatricula.setBounds(83, 382, 133, 15);
		...
		dataNascimento.setBounds(230, 217, 158, 20);
		try {
		...
		dataMatricula = new JFormattedTextField();
		dataMatricula.setBounds(83, 395, 158, 20);
		try {
			dataMatricula.setFormatterFactory(new DefaultFormatterFactory(new MaskFormatter("##/##/####")));
		} catch (ParseException e) {
			e.printStackTrace();
		}
		panel.add(dataMatricula);
	...
	protected void BtnCadastarActionPerformed(ActionEvent e) {
		...
		aluno.setData_matricula(dataMatricula.getText());
		aluno.setData_nascimento(dataNascimento.getText());
